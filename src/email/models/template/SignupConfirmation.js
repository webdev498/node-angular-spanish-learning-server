 import Message from '../Message';
  ...
  export default class SignupConfirmation extends Message {
    ...
    get body() {
      ...
      return `Thank you for registering ${this.recipient.firstName}, <p>Please complete the registration process by clicking this link:</p><a href="${callbackurl}">${callbackurl}</a>`;
    }
  }